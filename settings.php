						...
						<tr>
							...
							<td>
								<select name="currency" class="input-text">
									<option <?php if ($row['currency'] == "GBP") {?> selected <?php }?> value="GBP">GBP (MZN)</option>
									<option <?php if ($row['currency'] == "USD") {?> selected <?php }?> value="USD">USD (MZN)</option>
									<option <?php if ($row['currency'] == "EURO") {?> selected <?php }?> value="EURO">EURO (NZN)</option>
